...
import soloMapling.ArtificialPlayer.BotMovementSystem.MovementStructures.MovementPacketParseResult;
...
public class InPacketReader {
    ...
    public static InPacket byteArrayToInPacket(byte[] fullData) {
        ByteBuf byteBuf = Unpooled.wrappedBuffer(fullData);
    ...
    public static void appendRawDataToCsv(MovementPacket movementPacket) {
        ...
        MovementPacketParseResult parsedData =
                MovementPacket.parseNumCommandMovementPacketRecFromPacket(
                        movementPacket
                );
        ...
        int numCommands =
                parsedData.getNumCommands();


        List<SingleMoveCommand> recordList =
                parsedData.getCommands();


        MovementPacketRaw mpr =
                new MovementPacketRaw(
                        timestamp,
                        numCommands,
                        recordList
                );
